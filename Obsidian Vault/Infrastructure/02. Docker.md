...
| `docker save -o <path/tar/file> <image-name>`      | Save an image as tar archive           |
| `docker load -i <path/tar/file>`                   | Load a tar archive as a docker image   |
...
| `docker exec -it <container> sh/bash`                                              | Enter the container to execute commands                                  |
|                                                                                    |                                                                          |
...
| `docker import <file>`                                                             | Import a tar archive as a container                                      |
...
CMD  ["<command>", "path/to/script.extension"]
