...
> [!NOTE]
> Register is a mechanism for capturing a task’s output and storing it in a variable for use in later tasks.

```yaml
# Example using it to print output later
...
# Example using it for condition 
